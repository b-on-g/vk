namespace $.$$ {
	export class $bog_vk_app extends $.$bog_vk_app {
		...
		token_hint() {
			...
			return 'Открой vk.com → F12 → Console → вставь: window.open("https://oauth.vk.com/authorize?client_id=2685278&scope=audio,offline&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token") → скопируй access_token из URL'
		}
