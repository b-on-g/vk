...
;
	($.$bog_vk_tab) = class $bog_vk_tab extends ($.$mol_button_minor) {
		active(){
			return false;
		}
		attr(){
			return {...(super.attr()), "data-tab-active": (this.active())};
		}
	};
	($.$bog_vk_app) = class $bog_vk_app extends ($.$mol_page) {
		...
		Tab_my(){
			const obj = new this.$.$bog_vk_tab();
			(obj.click) = (next) => ((this.show_my(next)));
			(obj.active) = () => ((this.tab_my_active()));
			(obj.sub) = () => (["Моя музыка"]);
			return obj;
		}
		show_search(next){
		...
		Tab_search(){
			const obj = new this.$.$bog_vk_tab();
			(obj.click) = (next) => ((this.show_search(next)));
			(obj.active) = () => ((this.tab_search_active()));
			(obj.sub) = () => (["Поиск"]);
			return obj;
		}
		show_archive(next){
		...
		Tab_archive(){
			const obj = new this.$.$bog_vk_tab();
			(obj.click) = (next) => ((this.show_archive(next)));
			(obj.active) = () => ((this.tab_archive_active()));
			(obj.sub) = () => (["Архив"]);
			return obj;
		}
		Tabs(){
	...
	($mol_mem(($.$bog_vk_app.prototype), "Tab_search"));
	($mol_mem(($.$bog_vk_app.prototype), "show_archive"));
	($mol_mem(($.$bog_vk_app.prototype), "Tab_archive"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_action
        ], $bog_vk_app.prototype, "show_my", null);
        __decorate([
            $mol_action
        ], $bog_vk_app.prototype, "show_search", null);
        __decorate([
            $mol_action
        ], $bog_vk_app.prototype, "show_archive", null);
        __decorate([
            $mol_mem
